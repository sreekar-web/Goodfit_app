    ...
    <div className="bg-[#080904] text-white min-h-screen flex justify-center">
      <div className="w-full max-w-sm px-8 flex flex-col">
        ...
        <div className="flex justify-center mt-16 mb-8">
          <img src="/icons/framelogo.svg" className="w-24 h-24 rounded-2xl" />
        </div>

        {/* TITLE */}
        <h1 className="text-4xl font-bold leading-tight mb-2">Create Account</h1>
        <p className="text-[#A3A3A3] text-sm mb-8">Sign up to get started with Goodfit</p>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            <label className="text-xs text-[#6C7278] font-medium">Full Name</label>
            <input
              type="text"
              value={name}
          ...
          <div className="space-y-1">
            <label className="text-xs text-[#6C7278] font-medium">Phone Number</label>
            <input
              type="tel"
              value={phone}
