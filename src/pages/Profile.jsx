      ...
      <div className="w-full max-w-sm pb-32">
        ...
        <div className="bg-[#111] rounded-b-3xl px-5 pt-8 pb-10 relative">
          ...
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-lg font-bold">Sreekar Rachakonda</h2>
            <p className="text-gray-400 text-sm mt-0.5">+91 98765 43210</p>
          </div>
        </div>
        ...
        <div className="mx-4 mt-4">
          <button className="w-full border border-red-500/40 text-red-400 py-3 rounded-2xl text-sm font-semibold hover:bg-red-500/10 transition-colors">
            Log Out
          </button>
        </div>
